    ...
    return (
      <div className="min-h-screen pt-32 pb-16 flex flex-col items-center justify-center container-width text-center">
        ...
        <button 
          ...
          className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-full font-medium transition-transform active:scale-95"
        >
          Try Again
        </button>
      </div>
        ...
        <div className="space-y-16">
          {categories.map((category) => (
            <div key={category.id} id={category.id} className="scroll-mt-24">
              <h2 
                className="text-3xl font-bold border-b-2 border-primary inline-block pb-2 mb-8 text-foreground"
                data-aos="fade-right"
              >
                {category.name}
              </h2>
