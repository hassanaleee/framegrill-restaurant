    ...
    <div className="min-h-screen pt-24 pb-16 bg-background">
      <div className="container-width">
        <div className="text-center mb-16" data-aos="fade-up">
          <h1 className="text-4xl md:text-6xl font-black text-foreground mb-4 uppercase tracking-tight">Contact <span className="text-primary dark:text-accent">FrameGrill</span></h1>
            ...
            <div className="bg-card border border-border/50 p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-5 group">
                  <div className="bg-primary/10 dark:bg-accent/10 p-3 rounded-2xl text-primary dark:text-accent group-hover:bg-primary group-hover:text-primary-foreground dark:group-hover:bg-accent dark:group-hover:text-accent-foreground transition-colors">
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1"><a href="mailto:orders@flamegrill.pk" className="hover:text-primary dark:hover:text-accent transition-colors">orders@flamegrill.pk</a></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-8" data-aos="fade-left">
            ...
            <div className="w-full h-64 bg-muted border border-border/50 rounded-3xl overflow-hidden relative group">
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-background/50 backdrop-blur-sm group-hover:bg-background/30 transition-all z-10">
                <Navigation className="w-10 h-10 text-primary dark:text-accent mb-3" />
                <span className="font-bold text-lg text-foreground">Map View</span>
            ...
            <div className="bg-card border border-border/50 p-8 md:p-10 rounded-3xl shadow-sm">
              <h2 className="text-3xl font-black mb-8 uppercase text-foreground">Drop a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      id="name" 
                      required
                      className="w-full px-5 py-4 rounded-2xl border border-border/50 bg-background dark:bg-muted/30 focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-accent transition-all shadow-inner text-foreground"
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    rows={5}
                    required
                    className="w-full px-5 py-4 rounded-2xl border border-border/50 bg-background dark:bg-muted/30 focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-accent transition-all shadow-inner resize-none text-foreground"
                ...
                <button 
                  type="submit"
                  className="w-full bg-primary dark:bg-accent hover:bg-primary/90 dark:hover:bg-accent/90 text-primary-foreground dark:text-accent-foreground py-4 rounded-2xl font-black text-lg transition-transform active:scale-95 shadow-lg uppercase tracking-wider"
                >
                  Send Message
                </button>
              </form>
